...
namespace Vrektproject.Controllers
{
    ...
    public class ApplicationUsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoleIdentifier,Authorized,ProfileId,Id,UserName,NormalizedUserName,Email,NormalizedEmail,EmailConfirmed,PasswordHash,SecurityStamp,ConcurrencyStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEnd,LockoutEnabled,AccessFailedCount")] ApplicationUser applicationUser)
        {
            ...
            ViewData["ProfileId"] = new SelectList(_context.Profiles, "Id", "Id", applicationUser.ProfileId);
            return View(applicationUser);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("RoleIdentifier,Authorized,ProfileId,Id,UserName,NormalizedUserName,Email,NormalizedEmail,EmailConfirmed,PasswordHash,SecurityStamp,ConcurrencyStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEnd,LockoutEnabled,AccessFailedCount")] ApplicationUser applicationUser)
        {
